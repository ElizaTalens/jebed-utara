...
export const metadata = {
  title: "Dusun Watgalih Selatan - Desa Jebed Utara",
  description: "Informasi wilayah administrasi Dusun Watgalih Selatan, Desa Jebed Utara, Kecamatan Taman, Kabupaten Pemalang.",
};
